...
public class ListaLocalesFragment extends Fragment implements View.OnClickListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        LocalesAdapter adapter =new LocalesAdapter(listaLocales, this);
    ...
    public void onAttach(@NonNull Context context) {
        ...
        if(context instanceof ListaLocalesFragment.Callback){
            observador = (ListaLocalesFragment.Callback)context;
        } else {
